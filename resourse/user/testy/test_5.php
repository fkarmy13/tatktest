...
$result1 = mysqli_query($conn, "SELECT * FROM `test` WHERE id_test = '5'");
...
<body>
    <div class="card">
        ...
        <form action="process/log_5.php" method="POST">
            <div class="cards">
                <?php
                    $n = 0;
                    For ($i=1; $i<81; $i++) {
                        $r = $_POST[$i];
                        $res = mysqli_query($conn, "SELECT * FROM `question` WHERE id_test = '5' AND num_question = '$i'");
