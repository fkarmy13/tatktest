...
$g = $_SESSION['group'];
$re = mysqli_query($conn, "SELECT DISTINCT u.last_name, u.first_name, u.pathronymic, r.result, r.id_test, a.answer FROM `users` u, `result` r, `answer` a WHERE u.id_user=r.id_user AND r.id_test=a.id_test AND u.id_user=$id_user AND r.id_test = '2'");
...
<body>
  <? include("menu.php"); ?>
  <div class="card">
  <a href='../../../word_user.php?id_user=<?= $id_user?>&id_test=2'>Сохранить результат курсанта</a>
    <div class="cards">
